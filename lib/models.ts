...
const BASE_MODELS: ModelRegistryEntry[] = [
  ...
  },
  {
    ...
    modelId: "gpt-5.5",
    shortDescription:
      "Premium OpenAI model for complex reasoning, professional creative work, coding, and advanced prompt generation.",
    capabilities: ["text", "vision", "best_quality", "long_context", "structured_output"],
    costTier: "high",
    allowedRoles: ["TEAM_LEAD", "ADMIN"],
    preferredFor: ["reasoning"],
    listSection: "curated",
  ...
  },
  {
    ...
    modelId: "gpt-5.4",
    shortDescription:
      "Advanced OpenAI model for professional reasoning, visual prompt generation, and long-context work.",
    capabilities: ["text", "vision", "best_quality", "long_context", "structured_output"],
    costTier: "high",
    allowedRoles: ["TEAM_LEAD", "ADMIN"],
    preferredFor: ["reasoning"],
  ...
  },
  {
    ...
    shortDescription:
      "Fast, cost-efficient OpenAI model for everyday prompt generation, multimodal drafting, and assistant work.",
    capabilities: ["text", "vision", "fast", "long_context", "structured_output"],
    costTier: "low",
    allowedRoles: ["USER", "TEAM_LEAD", "ADMIN"],
