...
export function AgentStarterPrompts({
  ...
  return (
    <div className="mt-8" data-agent-id={agent.id}>
      <div className="mb-3 flex flex-col items-center gap-1 text-center">
        <div className="flex items-center justify-center gap-2 text-xs font-medium uppercase tracking-wide text-zinc-400 dark:text-zinc-500">
